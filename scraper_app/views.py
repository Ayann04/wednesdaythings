...
def _driver_from_config() -> webdriver.Chrome:
    """
    Initialize Chrome WebDriver with headless-friendly options.
...
def trigger_scrape(request):
    ...
    try:
        ...
        _create_status(new_run, f"Redirecting To -> https://sampada.mpigr.gov.in/#/clogin {timestamp_2}")
